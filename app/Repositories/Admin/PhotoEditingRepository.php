...
class PhotoEditingRepository extends BaseRepository {
    ...
    private $linkImages = "upload/admin/services/photo_editing";
    ...
    public function index($searchParams) {
        ...
        $query->where('service_id', PHOTO_EDITING);
        ...
        return view('admin.pages.services.photo-editing.index', compact('products'));
    }
