...
//tabbed Boxes
 	...
 	jQuery("div.cat-box-content").each(function(){
        ...
        jQuery( this ).find("div.btn-group ul li:first").addClass("active").show();
        jQuery( this ).find("div.btn-group ul li").click(function( event ) {
            event.preventDefault();
            jQuery( this ).parent().find("li").removeClass("active");
            jQuery( this ).addClass("active");
            jQuery( this ).parent().parent().parent().parent().find("div.cat-tabs-wrap").hide();
            var activeTab = jQuery(this).find("a").attr("href");
            jQuery(activeTab).fadeIn();
            return false;
