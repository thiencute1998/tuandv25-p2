...
@section('main-content')
    <div class="content">
        ...
        <div xmlns:v="http://rdf.data-vocabulary.org/#" id="crumbs"><span typeof="v:Breadcrumb"><a
                ...
                class="current">Search Results for: {{request()->segment(count(request()->segments()))}}</span></div>

        <div class="page-head">

            <h1 class="page-title">
                Search Results for: {{request()->segment(count(request()->segments()))}} </h1>
                ...
                <article class="item-list">
                    ...
                    <p class="post-meta">
                        ...
                        <span class="post-cats"><i class="fa fa-folder"></i>
                                @if($post->category)
                                <a
                                    href="{{route('get-cate', ['cate'=> $post->category->slug])}}" rel="category tag">{{$post->category->name}}
                                    </a>
                            @endif
                            {{--                                    , <a--}}
