    ...
    <div id="footer-widget-area" class="footer-3c">
        ...
        <div id="footer-first" class="footer-widgets-box">
            <div id="text-8" class="footer-widget widget_text"><div class="footer-widget-top"><h4>Liên hệ</h4></div>
                <div class="footer-widget-container">			<div class="textwidget"><p align="left">Tòa Giám Mục Bắc Ninh</p>
                        ...
                        <p align="left">Điện thoại: (+84) 222 3510 510</p>
                        <p align="left">Email: <strong><a href="mailto:bttgpbacninh@gmail.com">bttgpbacninh@gmail.com</a></strong></p>
                        <p align="left">© 2023 &#8211; Giáo Phận Bắc Ninh</p>
                    </div>
                </div></div><!-- .widget /-->		</div>
        ...
        <div id="footer-second" class="footer-widgets-box">
            <div id="facebook-widget-4" class="footer-widget facebook-widget"><div class="footer-widget-top"><h4>Kết nối		</h4></div>
                ...
                </div></div><!-- .widget /--><div id="custom_html-4" class="widget_text footer-widget widget_custom_html"><div class="footer-widget-top"><h4>Đăng ký kênh youtube</h4></div>
                <div class="footer-widget-container"><div class="textwidget custom-html-widget"><script src="https://apis.google.com/js/platform.js"></script>

                        <div class="g-ytsubscribe" data-channelid="UCUptnRy9DiV5brpsyJQFORg" data-layout="default" data-count="default"></div></div></div></div><!-- .widget /-->		</div><!-- #second .widget-area -->


        <div id="footer-third" class="footer-widgets-box">
            <div id="text-9" class="footer-widget widget_text"><div class="footer-widget-top"><h4>Liên kết websites</h4></div>
                <div class="footer-widget-container">			<div class="textwidget"><p><a href="http://w2.vatican.va/content/vatican/en.html" target="_blank" rel="noopener">Toà thánh Vatican</a></p>
                        <p><a href="https://www.vaticannews.va/vi.html" target="_blank" rel="noopener">Vatican News Tiếng Việt</a></p>
