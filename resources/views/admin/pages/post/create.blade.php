                            ...
                            <div class="card-body">
                                <form id="product-form" name="product-form" action="{{ route('admin-post-store') }}" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-3">
                                            <label for="services" class="col-form-label">Hình anh</label>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <?php $currentDate = date('Y/m/d H:i'); ?>
                                        <div class="col-md-3">
                                            <label for="services" class="col-form-label">Ngày đăng</label>
                                            <input type="text" id="my-date" name="post_date" value="{{$currentDate}}" class="form-control" placeholder="Ngày">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-12">
