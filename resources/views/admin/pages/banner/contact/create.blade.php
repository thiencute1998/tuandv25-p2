            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <form id="product-form" name="product-form" action="{{ route('contacts-store') }}" method="POST" enctype="multipart/form-data" class="dropzone border-0">
                                    @csrf
                                    @if (session('add-success'))
                                        <h5 class="contact-message mb-2 text-success">{{ session('add-success') }}</h5>
                                    @endif
                                    <h4 class="header-title product-add-title">Add contact banner</h4>
                                            ...
                                            <div class="form-group product-images mr-3">
                                                <div class="d-flex">
                                                    <div class="mb-3 mr-2 image-item" style="position: relative">
                                                        ...
                                                        <img width="240px" height="200px" class="contact-img">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
