                            ...
                            <div class="card-body">
                                <form id="product-form" name="product-form" action="{{ route('admin-calendar-update', ['id'=> $calendar->id]) }}" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="row form-group justify-content-between">
                                        <div>
                                            <h4 class="header-title product-add-title">Sửa lịch phụng vụ</h4>
                                        </div>
                                        <div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Nhập tên lịch phụng vụ" required value="{{$calendar->name}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="services" class="col-form-label">Trạng thái</label>
                                            <select class="form-control item-status" name="status" data-value="{{ $calendar->status }}">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="my-date" name="d_date" class="form-control" placeholder="Ngày"
                                                   value="{{ $calendar->d_date ? \Carbon\Carbon::createFromFormat('Y-m-d', $calendar->d_date)->format('m/d/Y') : null}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label for="services" class="col-form-label">Địa chỉ</label>
                                            <input type="text" class="form-control" name="address" placeholder="Địa chỉ" value="{{$calendar->address}}">
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="3" cols="200" type="text" class="form-control" name="keywords" placeholder="Nhập keywords"  >{{$calendar->keywords}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <label for="services" class="col-form-label">Description</label>
                                            <textarea rows="3" cols="200" type="text" class="form-control" name="description" placeholder="Nhập description"  >{{$calendar->description}}</textarea>
                                        </div>
                                    </div>
