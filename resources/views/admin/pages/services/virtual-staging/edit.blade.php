...
@section('main-content-inner')
    <div class="card-header filter-with" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        <div class="mb-0 ml-1">
            <a href="{{route('virtual-staging')}}">List Virtual Staging</a>
        </div>
    </div>
    <!-- page title area end -->
            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <form id="product-form" name="product-form" action="{{ route('virtual-staging-update', ['id'=> $product->id]) }}" method="POST" enctype="multipart/form-data" class="dropzone border-0">
                                    @csrf
                                    @if (session('edit-success'))
                                        <h5 class="product-message mb-2 text-success">{{ session('edit-success') }}</h5>
                                    @endif
                                    <h4 class="header-title product-add-title">Edit Virtual Staging</h4>
                                                ...
                                                <div class="form-group product-images mr-3">
                                                    <div class="d-flex">
                                                        <div class="mb-3 mr-2 image-item" style="position: relative">
                                                            ...
                                                            <img width="150px" height="150px" class="product-img" src="{{ asset('upload/admin/services/virtual_staging/'. $image->file_name_1) }}">
                                                        </div>
                                                        <div class="mb-3 mr-2 image-item" style="position: relative">
                                                            ...
                                                            <img width="150px" height="150px" class="product-img" src="{{ asset('upload/admin/services/virtual_staging/'. $image->file_name_2) }}">
                                                        </div>
