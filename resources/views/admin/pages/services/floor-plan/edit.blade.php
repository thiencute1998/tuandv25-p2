            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <form id="product-form" name="product-form" action="{{ route('floor-plan-update', ['id'=> $product->id]) }}" method="POST" enctype="multipart/form-data" class="dropzone border-0">
                                    @csrf
                                                ...
                                                <div class="form-group product-images mr-3">
                                                    <div class="d-flex">
                                                        <div class="mb-3 mr-2 image-item" style="position: relative">
                                                            ...
                                                            <img width="150px" height="150px" class="product-img" src="{{ asset('upload/admin/services/floor_plan/'. $image->file_name_1) }}">
                                                        </div>
                                                        <div class="mb-3 mr-2 image-item" style="position: relative">
                                                            ...
                                                            <img width="150px" height="150px" class="product-img" src="{{ asset('upload/admin/services/floor_plan/'. $image->file_name_2) }}">
                                                        </div>
