    ...
    <div class="row align-items-center" style="padding: 1.6rem 0;">
        <div class="col-md-6 col-sm-8">
            <div class="search-box pull-left">
                <form action="{{ route('floor-plan') }}" method="GET" >
                ...
                <div class="card-body">
                    <div class="row form-group justify-content-between">
                        <div >
                            ...
                            @endif
                            <h4 class="header-title">List Floor Plan</h4>
                        </div>
                        <div>
                            <a class="btn btn-primary" href="{{route('floor-plan-create')}}">
                            ...
                            <table class="table text-center">
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('floor-plan-edit', ['id'=> $product->id]) }}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a class="product-remove" href="{{ route('floor-plan-delete', ['id'=> $product->id]) }}"
