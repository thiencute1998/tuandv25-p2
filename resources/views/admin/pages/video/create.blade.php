            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-body">
                                <form id="product-form" name="product-form" action="{{ route('admin-video-store') }}" enctype="multipart/form-data" method="POST">
                                    @csrf
                                    ...
                                    <div class="row form-group justify-content-between">
                                        <div>
                                            <h4 class="header-title product-add-title">Thêm Video</h4>
                                        </div>
                                        <div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Nhập tên Video" required>
                                        </div>
                                        <div class="col-md-4">
